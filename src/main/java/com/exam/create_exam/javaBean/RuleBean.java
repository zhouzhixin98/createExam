...
public class RuleBean implements Serializable {
    ...
    public RuleBean(long id, long examId, int totalMark, double difficulty, int singleNum, double singleScore, int completeNum, double completeScore, int subjectiveNum, double subjectiveScore, List<String> pointIds, Date createTime) {
        this.id = id;
        this.examId = examId;
